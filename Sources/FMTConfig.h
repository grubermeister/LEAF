...
#define PLUGIN_ID_STRING        "LEAF"

#define PLUGIN_NAME             "ADI LEAF"
...
#define PLUGIN_INFO             "ADI's Language Extending Add-on for Filemaker"

#define COMPANY_NAME            "Allied Defense Industries"
#define COPY_STATEMENT          "Copyright ©2014 " COMPANY_NAME
...
#define PLUGIN_BUNDLE_ID    "com.adi.leaf"
...
#define FILE_NAME_PC        "LEAF.fmx"  // A hint for user who accidentally renames your plug-in

#define PLUGIN_INFO_PC      "ADI's Language Extending Add-on for Filemaker"

#define COMPANY_URL         "http://www.adiservices.com"
...
#define FUNCTION_1_C_NAME         LEAF_Version
...
#define FUNCTION_1_PROTOTYPE      "LEAF_Version( {versionFormat} )"

#define FUNCTION_2_C_NAME         LEAF_ExecutePython
...
#define FUNCTION_2_PROTOTYPE      "LEAF_ExecutePython( pathToFile; {arguments} )"
